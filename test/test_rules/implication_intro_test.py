...
testdata = [
    ...
    ("prf.lines[9][prf.ruleindex]", t.implication_intro_rulename),
    ...
    ("prf.lines[10][prf.ruleindex]", t.implication_intro_rulename),
...
testdata = [
    ...
    ("prf.lines[5][prf.ruleindex]", t.implication_intro_rulename),
...
testdata = [
    ...
    ("prf.lines[2][prf.levelindex]", 0),
    ("prf.lines[2][prf.proofidindex]", 0),
    ("prf.lines[2][prf.ruleindex]", t.implication_intro_rulename), # normal implication, not strict
    ("prf.lines[2][prf.linesindex]", ""),
    ("prf.lines[2][prf.proofsindex]", "1-1"),
    ("prf.lines[2][prf.commentindex]", "COMPLETE"),
]
...
testdata = [
    ...
    ("prf.lines[2][prf.levelindex]", 0),
    ("prf.lines[2][prf.proofidindex]", 0),
    ("prf.lines[2][prf.ruleindex]", t.implication_intro_name), # stopped so just name, not rulename
    ("prf.lines[2][prf.linesindex]", ""),
